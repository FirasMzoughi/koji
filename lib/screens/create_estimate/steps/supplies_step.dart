...
class _SuppliesStepState extends ConsumerState<SuppliesStep> {
  ...
  void _addSupply() {
    if (_nameController.text.isNotEmpty && _priceController.text.isNotEmpty) {
      ...
      ref.read(estimateProvider).addSupply(name, price, qty);
    ...
    return Column(
      children: [
        ...
        ListView.builder(
          ...
          itemCount: provider.tempSupplies.length,
          itemBuilder: (context, index) {
            final item = provider.tempSupplies[index];
            return Card(
        ...
        Row(
          ...
          children: [
            ...
            Text(
              NumberFormat.simpleCurrency(locale: 'fr_FR').format(provider.tempSuppliesCost),
